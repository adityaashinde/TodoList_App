...
import 'package:todolist_app/todox_modelclass.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromRGBO(
          102, 106, 246, 1), //102, 106, 246, 1),135, 138, 245, 1
      body: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const SizedBox(
          ...
          Container(
            margin: const EdgeInsets.only(left: 25, top: 45, bottom: 45),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                color: Color.fromRGBO(
                    135, 138, 245, 1), //102, 106, 246, 1  217, 217, 217, 1
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Container(
                    margin: const EdgeInsets.only(left: 25, top: 5, bottom: 10),
